...
function hasCertainKey(arr, key){
    return arr.every(function(value){
        //my solution will fail for falsy values that aren't undefined. Instead use:
        //return key in value;
        return value[key];
    });
}
...
/*
Write a function called hasCertainValue which accepts an array of objects and a key, and a value, and returns true if every single object in the array contains that
