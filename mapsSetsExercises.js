class MessageBoard {
    ...
    /*
    In your constructor method, you should assign two properties for each object created from the MessageBoard class. The first should be a property called messages 
    ...
    */
    ...
    Add a method called addMessage which accepts a string. The function should add a key and value to the messages map with a key of whatever the value of this.id 
    is and a value of whatever the string is that is passed to the function. The function should return the object created from the class so that the method
    ...
    */
    ...
    /*
    Add a method called findMessageById which accepts a number and returns the message in the messages map with the same key as the number passed to the function.
...
m.findMessageById() // undefined
    */
    ...
    /*
    Add a method called findMessageByValue which accepts a string and returns the message in the messages map with the same value as the string passed to the function.
    ...
    */
    ...
    findMessageByValue(valueToFind){
      for (let curValue of this.messages.values()){
        if(curValue === valueToFind){
            return curValue;
        }
      }
      return undefined; //don't need this
    }
    ...
    */
    ...
    removeMessage(idToRemove){
        this.messages.delete(idToRemove);
        return this;
    }
...
Write a function called countPairs which accepts an array of numbers and a number. The function should return the number of unique pairs (two numbers)
...
//HIS SOLUTION: he did it differently (created a cache from a set of the array values, iterated through array, deleted the current 
//array val from the cache, then did if (cache.has(num-val)) increment count)

//NOTE: mine technically isn't right, because the description says UNIQUE pairs. Must first make set to eliminate dupes. It passed all tests though.
